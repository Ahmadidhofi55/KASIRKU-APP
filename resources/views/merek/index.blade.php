...
@extends('merek.create')
@extends('merek.show')
@extends('merek.edit')
@section('title', 'Kasirku | Merek Produk')
@section('content')
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <a href="{{ route('kasir.kasir') }}" class="btn btn-primary btn-icon-split">
            ...
            <span class="text">MEREK PRODUK</span>
        </a>
        <!-- Topbar Navbar -->
    ...
    <script type="text/javascript">
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            // Cek apakah DataTable sudah ada sebelum reload
                            var dataTable = $('#dataTable').DataTable();
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '#btn-edit-post2', function() {
                ...
                // Fetch detail post with ajax
                $.ajax({
                    url: `/merek/show/${merek_id}`,
                    type: "GET",
                    cache: false,
                    success: function(response) {
                        // Fill data to form
                        $('#merek_id2').val(response.id);
            ...
            $('#update2').click(function(e) {
                ...
                // Define variables
                let pembayaran_id = $('#merek_id2').val();
                let name = $('#name-edit2').val();
                ...
                // Ajax
                $.ajax({
                    url: `/merek/update/${pembayaran_id}`,
                    type: "POST",
                    cache: false,
                    data: formData,
