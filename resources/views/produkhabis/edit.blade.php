    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">EDIT PRODUK HABIS</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control" id="name-edit2" name="name-edit2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control" id="qr_produk-edit2" name="qr_produk-edit2">
                ...
                <div class="form-group">
                    ...
                    <input type="file"  disabled class="form-control" name="qr_img-edit2" id="qr_img-edit2">
                ...
                <div class="form-group">
                    ...
                    <input type="file" disabled class="form-control" name="img-edit2" id="img-edit2">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" @readonly(true) id="merek_id-edit2" name="merek_id-edit2" >
                        <option value="" selected disabled>Pilih Merek</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="jenis_id-edit2" class="control-label">Jenis</label>
                    <select class="form-control" @readonly(true) id="jenis_id-edit2" name="jenis_id-edit2">
                        <option value="" selected disabled>Pilih Jenis</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="supliyer_id-edit2" class="control-label">Supplier</label>
                    <select class="form-control" @readonly(true) id="supliyer_id-edit2" name="supliyer_id-edit2">
                ...
                <div class="form-group">
                    ...
                    <input type="number" readonly class="form-control no-spinner" id="harga_jual-edit2" name="harga_jual-edit2">
                ...
                <div class="form-group">
                    ...
                    <input type="number" readonly class="form-control no-spinner" id="harga_beli-edit2"
                ...
                <div class="form-group">
                    ...
                    <input type="number" readonly class="form-control no-spinner" id="diskon-edit2" name="diskon-edit2">
                ...
                <div class="form-group">
                    ...
                    <input type="date" readonly class="form-control" id="tgl_exp-edit2" name="tgl_exp-edit2" >
